      ...
      <div className="relative z-10 w-full max-w-lg rounded-card bg-bg p-6 shadow-cardHover">
        ...
        <div className="mt-4 space-y-3">
          <div className="rounded-xl bg-surface p-4">
            ...
            <p className="mt-1 text-sm font-bold text-ink">국내: FinanceDataReader · 해외: yfinance</p>
            <p className="mt-1 text-xs text-sub">수급·뉴스: 네이버금융 크롤링 · 공포탐욕: VIX/KOSPI/환율 자체 산출</p>
          </div>
          ...
          <div className="rounded-xl bg-toss-50 p-4">
            ...
            <p className="mt-1 text-sm leading-6 text-toss-700/85">
              이 도구는 분석 전용입니다. 실제 매매는 외부 증권사 앱에서 수행하세요. 분석 결과는 CSV로 내보낼 수 있습니다.
            </p>
            <a href="https://www.tossinvest.com" target="_blank" rel="noopener noreferrer" className="mt-2 inline-flex items-center gap-1 text-sm font-bold text-toss hover:underline">
